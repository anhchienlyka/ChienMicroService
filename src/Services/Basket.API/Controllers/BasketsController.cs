...
public class BasketsController : Controller
{
    ...
    private readonly IPublishEndpoint _publishEndpoint; // của masstransit
    ...
    public async Task<ActionResult<CartDto>> UpdateBasket([FromBody] CartDto model)
    {
        ...
        var options = new DistributedCacheEntryOptions()
            .SetAbsoluteExpiration(DateTime.UtcNow.AddHours(1)) // set tồn tại trong vòng bao nhiêu lâu
            .SetSlidingExpiration(TimeSpan.FromMinutes(5)); // theo dõi hoạt động
